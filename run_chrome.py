...
def run_cmd( threadName, delay):
    ...
    subprocess.call('"C:\Program Files (x86)\Google\Chrome\Application\chrome"  --headless --disable-gpu  --remote-debugging-port=9221', shell=True)
